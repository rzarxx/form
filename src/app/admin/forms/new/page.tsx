    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        if (aiMergeMode === "replace") {
          ...
          setFields(aiFields);
          toast.success("Formulir baru berhasil dirancang oleh AI!");
        } else {
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-8 pb-36 space-y-6 relative z-10">
        ...
        <Card className="bg-indigo-50/40 border border-indigo-200/60 shadow-sm rounded-2xl relative overflow-hidden backdrop-blur-md">
          ...
          <CardHeader className="space-y-1.5 pt-6 pb-4 cursor-pointer select-none" onClick={() => setShowAiPanel(!showAiPanel)}>
            ...
            <CardDescription className="text-slate-500 text-xs">
              Buat formulir instan menggunakan kecerdasan buatan Gemini, OpenAI, atau OpenRouter. Cukup jelaskan topik formulir Anda.
            </CardDescription>
          </CardHeader>
                ...
                <>
                  <div className="space-y-2 pt-4">
                    <Label htmlFor="ai-prompt" className="text-indigo-900 text-xs font-bold flex items-center justify-between">
                      <span>Jelaskan formulir yang ingin Anda buat</span>
                      <span className="text-[10px] text-slate-400 font-normal">Contoh: "Form pendaftaran bimbel anak SD lengkap dengan biodata dan kelas"</span>
                    </Label>
                    <Textarea
                      id="ai-prompt"
        ...
        <Card className="bg-white border-slate-200 shadow-sm rounded-2xl relative overflow-hidden">
          ...
          <CardHeader className="space-y-1.5 pt-6">
            ...
            <CardDescription className="text-slate-500 text-xs">
              Tentukan judul identitas, deskripsi petunjuk pengisian, dan banner visual
            </CardDescription>
          </CardHeader>
        ...
        <Card className="bg-white border-slate-200 shadow-sm rounded-2xl relative overflow-hidden">
          ...
          <CardHeader className="space-y-1.5 pt-6">
            ...
            <CardDescription className="text-slate-500 text-xs">
              Kustomisasi penutupan deadline otomatis, redirect url, pesan terima kasih kustom, notifikasi email, keamanan, dan webhook
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 pt-0">
